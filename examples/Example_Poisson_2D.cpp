...
{   
    ...
    std::vector<double> x_weights{1.0, 0.6, 1.0};
    ...
    std::vector<double> y_weights{ 1.0,0.8,0.8,1.0 };
    ...
    BsplineSurface surface(std::vector<Bspline>{bspline_x, bspline_y}, controlPoints);
    for (int i = 0; i < 1; ++i)
    {
